        ...
        <Container bg={'bg-gradient-to-b from-neutral-900 to-black'}>
                <article className="flex flex-col items-center lg:items-start h-1/2 lg:w-1/2 lg:h-96">
                    ...
                    <ul className=" h-full flex lg:flex-col gap-6 mt-10 flex-wrap">
                        <li className="flex items-center gap-4"><HiOutlineMail className="w-8 h-8 text-neutral-400 hover:text-blue-500 hover:transition-all hover:duration-300 hover:cursor-pointer hover:transform hover:scale-110 transition-all" /><p className="hidden lg:inline hover:transition-all hover:duration-300 hover:cursor-pointer  transition-all"><a href="mailto:gustavo.grando0909@gmail.com" className="text-neutral-500 hover:text-blue-500 transition-all">gustavo.grando0909@gmail.com</a></p></li>
                        <li className="flex items-center gap-4"><FiGithub className="w-8 h-8 text-neutral-400 hover:text-blue-500 hover:transition-all hover:duration-300 hover:cursor-pointer hover:transform hover:scale-110 transition-all" /><p className="hidden lg:inline hover:transition-all hover:duration-300 hover:cursor-pointer  transition-all"><a href="https://www.linkedin.com/in/gugrando/" className="text-neutral-500 hover:text-blue-500 transition-all">linkedin.com/in/gugrando</a></p></li>
                        <li className="flex items-center gap-4"><PiLinkedinLogoBold className="w-8 h-8 text-neutral-400 hover:text-blue-500 hover:transition-all hover:duration-300 hover:cursor-pointer hover:transform hover:scale-110 transition-all" /><p className="hidden lg:inline hover:transition-all hover:duration-300 hover:cursor-pointer  transition-all"><a href="https://github.com/gugrando " className="text-neutral-500 hover:text-blue-500 transition-all">github.com/gugrando</a></p></li>
                        <li className="flex items-center gap-4"><FiInstagram className="w-8 h-8 text-neutral-400 hover:text-blue-500 hover:transition-all hover:duration-300 hover:cursor-pointer hover:transform hover:scale-110 transition-all" /><p className="hidden lg:inline hover:transition-all hover:duration-300 hover:cursor-pointer  transition-all"><a href="https://instagram.com/oguvieira_ " className="text-neutral-500 hover:text-blue-500 transition-all">instagram.com/oguvieira_</a></p></li>
                    </ul>
